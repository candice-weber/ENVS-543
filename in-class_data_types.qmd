...
sqrOfNegative2
```
The result is negative 4 because of order of operations.  If you put a parentheses around the -2, you will get the correct answer of positive 4.
...
```{r}
properName <- paste(lastname, firstname, sep = ", ")
properName
```
